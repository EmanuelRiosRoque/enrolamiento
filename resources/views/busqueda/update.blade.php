                ...
                <x-container>
                    ...
                    <div class="p-6">
                        <form method="POST" action="{{ route('update.update', ['id' => $data['nuM_EMPL']]) }}" class="max-w-md mx-auto">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" name="rfc" id="floating_RFC" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" " required value="{{$data['rfc']}}"  disabled/>
