    ...
    public function fetchData()
{
    ...
    if ($response !== false) {
        ...
        if ($responseData !== null) {
            // Verifica si la respuesta indica un empleado inválido
            if ($responseData['status'] === 'FAIL' && $responseData['descripcion'] === 'Empleado Invalido') {
                $this->error = 'Empleado inválido. Verifique el número de empleado.';
                $this->hideLoader();
                return;
            }
